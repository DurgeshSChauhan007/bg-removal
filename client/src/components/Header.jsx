  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='my-6 text-[15px] text-gray-500'>Say goodbye to manual editing! Our AI-driven Background Removal SaaS lets <br className='max-sm:hidden' /> you remove backgrounds from images in seconds—fast, accurate, and effortless. <br className='max-sm:hidden' />Whether you're an e-commerce seller, designer, or content creator, our tool ensures <br className='max-sm:hidden' /> high-quality, transparent backgrounds for any image.</p>
            <div>
